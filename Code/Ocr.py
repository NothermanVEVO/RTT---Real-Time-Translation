...
# def get_rectangles_from_pil(image: Image.Image, image_scale: float = 1.0, max_gap_distance: int = 10) -> List[Rectangle.Rectangle]: #! PADDLEOCR V5
#     image_cv = pil_to_cv(image)
#     rectangles = []
