...
def get_rectangles(img_resized_path : str, max_gap_distance : int = 10) -> List[Rectangle]:
    inicio = time.time()
    print("Lendo imagem...")
...
img_resized_path = resize_image(caminho_imagem, image_scale)

resultado = get_rectangles(img_resized_path)
